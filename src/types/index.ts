...
export type ProductUnit = 'pza' | 'kg' | 'g' | 'lt' | 'ml' | 'caja' | 'paq' | 'rollo' | 'par'
export type SaleStatus = 'pending' | 'completed' | 'canceled' | 'returned'
export type PaymentMethod = 'cash' | 'card' | 'transfer' | 'credit'
export type PaymentStatus = 'pending' | 'completed' | 'failed' | 'refunded'
export type InventoryMovementType = 'sale' | 'purchase' | 'adjustment' | 'return' | 'loss' | 'initial'
...
export type FeatureKey =
  | 'card_payments' | 'csv_import' | 'scale' | 'thermal_printer'
  | 'multi_branch' | 'advanced_reports' | 'api_access'
  | 'suppliers' | 'customers' | 'stock_alerts' | 'basic_reports'
